...
public class CrearArchivoMap {
    ...
    public void cargaArchivo() {
        try {
            ...
            writer.write("  EXTENT 388107.634400379 5203120.88405952 500896.339019834 5310243.30613897");writer.newLine();
            ...
            writer.newLine();
            writer.write("      WMS_SRS \"EPSG:26915\"");writer.newLine();
            writer.write("    END");writer.newLine();
            writer.write("  END");writer.newLine();
            writer.newLine();
            writer.write("# capa principal-------------------------------------------");writer.newLine();
            writer.write("  LAYER");writer.newLine();
            writer.write("    NAME ctybdpy2");writer.newLine();
            writer.write("    TYPE POLYGON");writer.newLine();
            writer.write("    STATUS DEFAULT");writer.newLine();
            writer.write("    DATA ctybdpy2");writer.newLine();
            writer.newLine();
            writer.write("    CLASSITEM 'cty_name'");writer.newLine();
            ...
            writer.write("    END");writer.newLine();
            writer.write("    METADATA");writer.newLine();
            writer.write("      WMS_TITLE \"County Boundary\"");writer.newLine();
            writer.write("      WMS_ABSTRACT \"Itasca County boundary shapefile. See http://deli.dnr.state.mn.us/metadata/full/ctybdne2.html for more information.\"");writer.newLine();
            writer.write("      WMS_SRS \"EPSG:26915\"");writer.newLine();
            writer.write("    END");writer.newLine();
            writer.write("  END");writer.newLine();
            ...
            writer.newLine();
            writer.write("  LAYER");writer.newLine();
            writer.write("    NAME dlgstln2");writer.newLine();
            writer.write("    TYPE LINE");writer.newLine();
            writer.write("    STATUS OFF");writer.newLine();
            writer.write("    DATA dlgstln2");writer.newLine();
            writer.newLine();
            writer.write("    CLASS");writer.newLine();
            writer.write("      NAME 'Lakes & Rivers'");writer.newLine();
            writer.write("      TEMPLATE \"templates / dlgstln2.html\"");writer.newLine();
            writer.write("      STYLE");writer.newLine();
            writer.write("        COLOR 49 117 185");writer.newLine();
            writer.write("      END");writer.newLine();
            writer.write("    END");writer.newLine();
            writer.newLine();
            writer.write("    HEADER \"templates / dlgstln2_header.html\"");writer.newLine();
            writer.write("    FOOTER \"templates / dlgstln2_footer.html\"");writer.newLine();
            writer.newLine();
            ...
            writer.newLine();
            writer.write("  LAYER");writer.newLine();
            writer.write("    NAME lakespy2");writer.newLine();
            writer.write("    TYPE POLYGON");writer.newLine();
            writer.write("    STATUS OFF");writer.newLine();
            writer.write("    DATA lakespy2");writer.newLine();
            writer.newLine();
            writer.write("    CLASS");writer.newLine();
            writer.write("      NAME 'Lakes & Rivers'");writer.newLine();
